"""Re-evaluate MPaGE's historical best-HV SEMO heuristic with TSP validity.

The embedded heuristic is the one whose MPaGE log reports historical mean HV
271.28645227989284. Candidate node IDs are coerced to integers before the full
permutation constraint is checked.
"""
...
def tour_cost(
    ...
    """Calculate a closed-tour cost after integer coercion and validation."""
...
def run_benchmark(args: argparse.Namespace) -> dict:
    ...
    result = {
        "algorithm": "SEMO with MPaGE historical-best heuristic and integer-coerced feasibility",
